...
class PR_Content_Blocks
{
	...
	public function create_shortcode( $atts ) {
		...
		return sprintf( '<div class="pr-content-blocks content-block block-id-%d block-%s">%s</div>', $content_block->ID, $content_block->post_name, wpautop( do_shortcode( $content_block->post_content ) ) );
	}
